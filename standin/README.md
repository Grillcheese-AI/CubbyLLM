...
**Gemma skipped (owner, 2026-09-04): the bake-off is LFM2.5-2.6B vs Qwen3-4B. Decision pending the on-card probe of Qwen's Q4 (VRAM beside the emitter, tokens/s) — the one number the rule still needs; both Q4s are local: `standin/models/emitter_v9t.Q4_K_M.gguf` (the talk control) and `standin/models/talk_v9t_qwen3_4b.Q4_K_M.gguf`.** The local replay of each arm's `val_generations.json` is the number of record.
